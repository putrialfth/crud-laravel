...
@error('nama_mahasiswa') is-invalid @enderror" name="nama_mahasiswa" value="{{ old('nama_mahasiswa') }}" placeholder="Masukkan Nama Lengkap Mahasiswa">
                ...
                <button type="submit" class="btn btn-success btn- primary">SIMPAN</button>
